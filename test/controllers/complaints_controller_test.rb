...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { content: @complaint.content, email_address: @complaint.email_address } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { content: @complaint.content, email_address: @complaint.email_address } }
